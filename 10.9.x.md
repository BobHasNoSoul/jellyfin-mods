...
once done you can go to your install login page and reload the cache in your browser to see your new test link.
...
````
button","lastFocused");button.setAttribute("data-index","2");button.appendChild(title);(function e(){const tabb=document.querySelector(".emby-tabs-slider");tabb?tabb.appendChild(button):setTimeout(e,500)})();
````  
